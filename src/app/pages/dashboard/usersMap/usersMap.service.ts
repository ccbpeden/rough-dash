  ...
  getData() {
    ...
    return {
      ...
      dataProvider: {
        ...
        zoomLatitude: 52,
        areas: [
          { title: 'Austria', id: 'AT', color: layoutColors.dangerLight, customData: '1 244', groupId: '1'},
          { title: 'Ireland', id: 'IE', color: layoutColors.dangerLight, customData: '1 342', groupId: '1'},
          { title: 'Denmark', id: 'DK', color: layoutColors.dangerLight, customData: '1 973', groupId: '1'},
          { title: 'Finland', id: 'FI', color: layoutColors.dangerLight, customData: '1 573', groupId: '1'},
          { title: 'Sweden', id: 'SE', color: layoutColors.dangerLight, customData: '1 084', groupId: '1'},
          { title: 'Great Britain', id: 'GB', color: layoutColors.dangerLight, customData: '1 452', groupId: '1'},
          { title: 'Italy', id: 'IT', color: layoutColors.dangerLight, customData: '1 321', groupId: '1'},
          { title: 'France', id: 'FR', color: layoutColors.dangerLight, customData: '1 112', groupId: '1'},
          { title: 'Spain', id: 'ES', color: layoutColors.dangerLight, customData: '1 865', groupId: '1'},
          { title: 'Greece', id: 'GR', color: layoutColors.dangerLight, customData: '1 453', groupId: '1'},
          { title: 'Germany', id: 'DE', color: layoutColors.dangerLight, customData: '1 957', groupId: '1'},
          { title: 'Belgium', id: 'BE', color: layoutColors.dangerLight, customData: '1 011', groupId: '1'},
          { title: 'Luxembourg', id: 'LU', color: layoutColors.dangerLight, customData: '1 011', groupId: '1'},
          { title: 'Netherlands', id: 'NL', color: layoutColors.dangerLight, customData: '1 213', groupId: '1'},
          { title: 'Portugal', id: 'PT', color: layoutColors.dangerLight, customData: '1 291', groupId: '1'},
